...
class PassInterceptionDrawer:
    def __init__(self):
        pass
    def get_team_pass_interception_count(self, passes, interceptions):
        team_1_passes = []
        team_2_passes = []
    ...
    def draw_frame(self, frame, frame_num, passes,interceptions):
        ...
        team_1_passes, team_2_passes, team_1_interceptions, team_2_interceptions = self.get_team_pass_interception_count(
